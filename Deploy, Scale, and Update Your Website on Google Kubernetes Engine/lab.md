...
```
curl -LO https://raw.githubusercontent.com/praveen2905/GoogleCloudSkillBoost/refs/heads/main/Deploy%2C%20Scale%2C%20and%20Update%20Your%20Website%20on%20Google%20Kubernetes%20Engine/praveen.sh
...
<div style="text-align: center; display: flex; flex-direction: column; align-items: center; gap: 20px;">
  ...
  <a href="https://www.youtube.com/@PraveenTech1?sub_confirmation=1" target="_blank">
